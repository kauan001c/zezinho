...
<head>
    ...
    <title>Zezinho Sports - Paixão pelo Futebol</title>
    ...
    <style>
        ...
        * {
        ...
        .soccer-field {
            ...
            height: 100%;
            z-index: -2;
            background: linear-gradient(rgba(13, 27, 42, 0.85), rgba(10, 10, 10, 0.9)), 
                        url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="180" viewBox="0 0 100 180"><rect x="0" y="0" width="100" height="180" fill="%2300CC4B" opacity="0.3"/><path d="M50,0 L50,180 M0,90 L100,90" stroke="white" stroke-width="2" opacity="0.2"/><circle cx="50" cy="90" r="20" fill="none" stroke="white" stroke-width="2" opacity="0.2"/></svg>');
            background-size: 200px 360px;
            animation: fieldMove 20s infinite linear;
        }
